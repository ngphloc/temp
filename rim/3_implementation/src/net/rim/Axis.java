...
import javax.vecmath.*;
	...
	private Geometry createGeometry(){
	    ...
	    axisLines.setCoordinate( 0, new Point3d(-1.0f, 0.0f, 0.0f));
	    axisLines.setCoordinate( 1, new Point3d( 1.0f, 0.0f, 0.0f));
	    axisLines.setCoordinate( 2, new Point3d( 0.9f, 0.1f, 0.1f));
	    axisLines.setCoordinate( 3, new Point3d( 0.9f,-0.1f, 0.1f));
	    axisLines.setCoordinate( 4, new Point3d( 0.9f, 0.1f,-0.1f));
	    axisLines.setCoordinate( 5, new Point3d( 0.9f,-0.1f,-0.1f));
	    axisLines.setCoordinate( 6, new Point3d( 0.0f,-1.0f, 0.0f));
	    axisLines.setCoordinate( 7, new Point3d( 0.0f, 1.0f, 0.0f));
	    axisLines.setCoordinate( 8, new Point3d( 0.1f, 0.9f, 0.1f));
	    axisLines.setCoordinate( 9, new Point3d(-0.1f, 0.9f, 0.1f));
	    axisLines.setCoordinate(10, new Point3d( 0.1f, 0.9f,-0.1f));
	    axisLines.setCoordinate(11, new Point3d(-0.1f, 0.9f,-0.1f));
	    axisLines.setCoordinate(12, new Point3d( 0.0f, 0.0f,-1.0f));
	    axisLines.setCoordinate(13, new Point3d( 0.0f, 0.0f, 1.0f));
	    axisLines.setCoordinate(14, new Point3d( 0.1f, 0.1f, 0.9f));
	    axisLines.setCoordinate(15, new Point3d(-0.1f, 0.1f, 0.9f));
	    axisLines.setCoordinate(16, new Point3d( 0.1f,-0.1f, 0.9f));
	    axisLines.setCoordinate(17, new Point3d(-0.1f,-0.1f, 0.9f));
