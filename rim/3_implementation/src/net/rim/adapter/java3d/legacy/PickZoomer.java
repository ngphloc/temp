 ...
 *
 */
public class PickZoomer extends PickBehavior {
	 ...
	 * @param bounds
	 */
	public PickZoomer(BranchGroup root, Canvas3D canvas, Bounds bounds) {
	...
	protected MouseBehavior createMouseBehavior() {
		...
		return new MouseZoomer(MouseRotate.MANUAL_WAKEUP);
	}
